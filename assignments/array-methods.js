...
//     n = runners[i].first_name +' '+runners[i].last_name;
//     fullName.push(n);
// }
fullName = [];
...
// Problem 1
// provide the information of all the people who gave a substantial donation >200
const subdon = runners.filter (function(currentValue){
    return currentValue.donation > 200;
});
console.log(subdon);
// Problem 2
//sort the runners by last name alphabetically
const alpha = runners.map( function(currentValue){
    return currentValue.last_name;
});
console.log(alpha.sort());
// Problem 3
//get the Emails of each runner
const em = runners.map( function(currentValue){
